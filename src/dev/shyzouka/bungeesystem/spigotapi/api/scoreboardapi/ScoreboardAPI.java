package dev.shyzouka.bungeesystem.spigotapi.api.scoreboardapi;
...
public class ScoreboardAPI {
    ...
    public String getLine(int line) {
        return this.scoreMap.get(Integer.valueOf(line));
    }

    public void setLine(int score, String prefix, String suffix) {
        this.scoreMap.put(Integer.valueOf(score), prefix + ";" + suffix);
    }
    ...
    public void addAnimation(String[] animationCont, Plugin plugin, long animationTimeInTicks) {
        this.animationContext = animationCont;
        animationTime = animationTimeInTicks;
